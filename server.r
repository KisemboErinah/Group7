...
#.....lists the different data columns in order....
  ...
  #......matches the data column education....
    ...
    tuti <- reactive({
      ...
      tik <- subset(my_data2(), colnames(my_data2()[7]) == input$column)
        factor(tik[,7])}
      else if(colnames(my_data2()[75]) == input$column){
        tik <- subset(my_data2(), colnames(my_data2()[75]) == input$column)
        factor(tik[,75])
      }
    ...
    tik <- subset(my_data2(),FormalEducation == input$formaleducation)
      ...
      barplot(termFrequency,las = 2, col = rainbow(24))
        ...
        ggplot(tik, aes(x= as.factor(tik[,84]))) + geom_bar() + coord_flip()
        ...
        ggplot(tik, aes(x= as.factor(tik[,81]))) + geom_bar() + coord_flip() 
        ...
        ggplot(tik, aes(x= as.factor(tik[,100]))) + geom_bar() + coord_flip() 
        ...
        ggplot(tik, aes(x= as.factor(tik[,103]))) + geom_bar() + coord_flip() 
        ...
        ggplot(tik, aes(x= as.factor(tik[,105]))) + geom_bar() + coord_flip() 
        ...
        ggplot(tik, aes(x= as.factor(tik[,108]))) + geom_bar() + coord_flip() 
        ...
        ggplot(tik, aes(x= as.factor(tik[,116]))) + geom_bar() + coord_flip() 
        ...
        ggplot(tik, aes(x= as.factor(tik[,16]))) + geom_bar() + coord_flip() 
        ...
        ggplot(tik, aes(x= as.factor(tik[,15]))) + geom_bar() + coord_flip() 
        ...
        ggplot(tik, aes(x= as.factor(tik[,13]))) + geom_bar() + coord_flip() 
    ...
    output$first <- renderPlot({
      ...
      pie(termFrequency, col = rainbow(12))
      }
        ...
        ggplot(tik, aes(x= as.factor(AdsAgreeDisagree1),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(AdsAgreeDisagree1)), width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                      label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the responses to the AdsAgreeDisagree1 Question by the developers"))+
        ...
        ggplot(tik, aes(x= as.factor(AdBlocker),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(AdBlocker)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                    label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the reponses to the AdBlocker Question by the Devlopers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AdBlockerDisable),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(AdBlockerDisable)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                  label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing responses to the Adblocker Question by the Developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(Student),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(Student)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing the Students and non Students"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(OpenSource),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(OpenSource)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                      label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing the reponses to the OpenSource Question by the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(Hobby),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(Hobby)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                            label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing the responses to the Hobby Question by the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(UndergradMajor),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(UndergradMajor)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                              label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing  the Under graduation Major of the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(YearsCoding),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(YearsCoding)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                        label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing the years spent coding by the developers"))+
        ...
        ggplot(tik, aes(x= as.factor(JobSatisfaction),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(JobSatisfaction)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing how the devlopers are satisfied by their current jobs"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(CareerSatisfaction),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(CareerSatisfaction)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                      label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing how the developers are satisfied by their careers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(HopeFiveYears),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(HopeFiveYears)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                            label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing what the developers hope to accomplish in yht next five years"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(JobSearchStatus),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(JobSearchStatus)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing the Job searching status of the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(LastNewJob),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(LastNewJob)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                      label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing When the developers last got a new job"))+
          xlab("Responses")+ylab("Total")
      }
        ...
        ggplot(tik, aes(x= as.factor(UpdateCV),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(UpdateCV)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                  label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing why the developers last changed thier CVs"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(Currency),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(Currency)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                  label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the currecy type earned by the developers"))+
        ...
        ggplot(tik, aes(x= as.factor(TimeFullyProductive),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(TimeFullyProductive)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                        label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing how long a new developer can fully become productive to a new team"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(TimeAfterBootcamp),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(TimeAfterBootcamp)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                    label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing how long it took the developers to get a job after bootcamp"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(NumberMonitors),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(NumberMonitors)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                              label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the number of monitors used by the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(CheckInCode),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(CheckInCode)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                        label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing the number of times the delopers have committed in their code"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(EthicsChoice),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(EthicsChoice)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                          label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing whether  developers can write unethical code or not"))+
        ...
        ggplot(tik, aes(x= as.factor(EthicsResponsible),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(EthicsResponsible)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                    label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing who is responsible for the ethics of the code"))+
          xlab("Responses")+ylab("Total")
        
      }
      else if(colnames(my_data2()[103]) == input$column){
        tik <- subset(my_data2(),colnames(my_data2()[103]) == input$column)
        ggplot(tik, aes(x= as.factor(StackOverflowVisit),y = prop.table(..count..) * 100)) + geom_baraes(aes(fill=factor(StackOverflowVisit)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                         label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing how frequently the developers visit StackOverflow"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(StackOverflowHasAccount),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(StackOverflowHasAccount)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                                label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing whether the developers have an account on StackOverflow or not"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(StackOverflowParticipate),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(StackOverflowParticipate)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                                  label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing how frequently the developersparticipte on stackOverflow"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(StackOverflowJobs),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(StackOverflowJobs)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                    label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing whether the developers visit the StackOverflow jobs or not"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(StackOverflowConsiderMember),y = prop.table(..count..) * 100)) + geom_bar(aes(fill= factor(StackOverflowConsiderMember)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                                         label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing whether the developers consider themselves as part of StackOverflow"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(HypotheticalTools1),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(HypotheticalTools1)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                      label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing the level to which developers are interested in the peer mentoring system"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(HypotheticalTools2),y = prop.table(..count..) * 100)) + geom_bar(aes(fill= factor(HypotheticalTools2)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                       label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing the level to which the developres like a privete platform for peaple new to coding"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(HypotheticalTools3),y = prop.table(..count..) * 100)) + geom_bar(aes(fill= factor(HypotheticalTools3)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                       label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing to what level the developers would like a programming oriented blog platform"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(HypotheticalTools4),y = prop.table(..count..) * 100)) + geom_bar(aes(fill= factor(HypotheticalTools4)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                       label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing to what level the devlopers are interested in the employer/ job review sysytem"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(HypotheticalTools5),y = prop.table(..count..) * 100)) + geom_bar(aes(fill = factor(HypotheticalTools5)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                        label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing to what level the developers are interested in an area with Q&A related to career growth"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(HoursComputer),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(HoursComputer)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                            label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing the number of hours spent on the computer by the developers"))+
        ...
        ggplot(tik, aes(x= as.factor(HoursOutside),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(HoursOutside)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                          label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing the number of hours spent outside by the developers"))+
          xlab("Time")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(SkipMeals),y = prop.table(..count..) * 100)) + geom_bar(aes(fill= factor(SkipMeals)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                     label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing how frequently the developers skip meals to code"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(Exercise),y = prop.table(..count..) * 100)) + geom_bar(aes(fill= factor(Exercise)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                   label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal() + ggtitle(paste("A bar graph showing how freqeuntly the developres exercise"))+
        ...
        ggplot(tik, aes(x= as.factor(Gender),y = prop.table(..count..) * 100)) + geom_bar(aes(fill= factor(Gender)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                               label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing Gender of the developers"))+
        ...
        ggplot(tik, aes(x= as.factor(Dependents),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(Dependents)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                      label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the developers with dependents"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(MilitaryUS),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(MilitaryUS)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                      label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the developers that are part of the US army"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(SurveyTooLong),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(SurveyTooLong)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                            label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the developers' responses to the length of the survey"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(SurveyEasy),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(SurveyEasy)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                     label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the developers' responses to structure of the survey"))+
          xlab("Age groups")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(Age),y = prop.table(..count..) * 100)) + geom_bar(aes(fill= factor(Age)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                         label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing Age groups of the developers"))+
          xlab("Age groups")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AdsAgreeDisagree2),y = prop.table(..count..) * 100)) + geom_bar(aes(fill= factor(AdsAgreeDisagree2)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                     label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the reponses to the AdsAgreeDisagree2 question by the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AdsAgreeDisagree3),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(AdsAgreeDisagree3)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                    label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the responses to the AdsAgreeDisAgree3 Question by the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(EthicsReport),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(EthicsReport)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                          label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing whether the developers can report unethical code"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(EthicalImplications),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(EthicalImplications)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                        label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing whether the developers think that unethical code has implications"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AIDangerous),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(AIDangerous)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                        label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the most dangerous aspect of AI basing on the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AIInteresting),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(AIInteresting)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                            label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the most interesting aspect of AI  basing on the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AIResponsible),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(AIResponsible)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                            label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing who should be responsible to the AI effects basing on the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AIFuture),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(AIFuture)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                  label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing  the future of AI basing on the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(StackOverflowRecommend),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(StackOverflowRecommend)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                              label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing how the developers are likely to recommend people to use StackOverflow"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(StackOverflowJobsRecommend),y = prop.table(..count..) * 100)) + geom_bar(aes(fill= factor(StackOverflowJobsRecommend)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                                       label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing how likely developers are to recommend people tomStackOverflow jobs"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(Employment),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(Employment)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                      label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the employment type of the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AgreeDisagree1),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(AgreeDisagree1)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                              label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7)  + theme_minimal()+ ggtitle(paste("A bar graph showing whether the developers feel kinship to other developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AgreeDisagree3),y = prop.table(..count..) * 100)) + geom_bar(aes(fill= factor(AgreeDisagree3)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                               label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing whether the developers think are not good at programming as thier peers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(SexualOrientation),y = prop.table(..count..) * 100)) + geom_bar(aes(fill=factor(SexualOrientation)),width = 0.1,position = "dodge") + coord_flip() + theme(aspect.ratio = 1/5) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                                    label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the sexualorientation of the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessJob1),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessJob1))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                   label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance the company the developers are working in is"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessJob2),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessJob2))) + coord_flip() +  theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                    label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance the financial status of the company is"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessJob3),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessJob3))) + coord_flip() +  theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                    label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of imporatnce the department the developers are working with is"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessJob4),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessJob4))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                   label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance the language and framework the developers are working with"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessJob5),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessJob5))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                   label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance the benefits of the job are to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessJob6),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessJob6))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                   label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the levelof importance the company culture is to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessJob7),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessJob7))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                   label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance the opportunity to work at home is to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessJob8),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessJob8))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                   label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance the opportunity for proffesional development is to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessJob9),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessJob9))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                   label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance the diversity of the company is to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessJob10),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessJob10))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                     label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance the impact of the service/product is to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessBenefits1),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessBenefits1))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                             label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance of the salary at a new job to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessBenefits2),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessBenefits2))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                             label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance of the shares at the new job to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessBenefits3),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessBenefits3))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                             label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance of the health insurance at the ne job to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessBenefits4),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessBenefits4))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                             label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance of the parental leave at the new job to the developers "))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessBenefits5),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessBenefits5))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                             label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance of the fittness benefits at the new job to the developers "))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessBenefits6),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessBenefits6))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                             label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance the retirement saving at the new job to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessBenefits7),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessBenefits7))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                             label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importace the company meals at new job are to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessBenefits8),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessBenefits8))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                             label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the the level of importance of the office equipment allownce at the new job to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessBenefits9),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessBenefits9))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                             label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance of the child care benefit at the new job to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessBenefits10),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessBenefits10))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                               label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance ofthe transportation benefit at the new job to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AssessBenefits11),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AssessBenefits11))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                               label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance of the conference/education budget at the new job to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(JobContactPriorities1),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(JobContactPriorities1))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                         label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of preference by the developers to be contacted on telephone cell"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(JobContactPriorities2),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(JobContactPriorities2))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                         label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of preference by the developers to be contacted on the private address email"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(JobContactPriorities3),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(JobContactPriorities3))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                         label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of preference by the developers to be contacted on the work address email"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(JobContactPriorities4),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(JobContactPriorities4))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                         label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of preference by the developers to be contacted on job site"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(JobContactPriorities5),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(JobContactPriorities5))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                         label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of preference by the developers to be contacted on a social media site"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(JobEmailPriorities1),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(JobEmailPriorities1))) + coord_flip()  + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                      label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance the details of company the developer is to be working in being included in the job contact message"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(JobEmailPriorities2),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(JobEmailPriorities2))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                     label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance the department the devloper is to work with being included in the job contact message."))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(JobEmailPriorities3),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(JobEmailPriorities3))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                     label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance of including the specificcs as to why the developer is a good fit for the job in the job contact message"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(JobEmailPriorities4),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(JobEmailPriorities4))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                     label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance of including the technologies the developer is to work with in job contact message"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(JobEmailPriorities5),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(JobEmailPriorities5))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                     label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance of including the company compensation range to the developers in the job contact message"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(JobEmailPriorities6),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(JobEmailPriorities6))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                     label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importanc eof  including the company hiring process in the job contact message to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(JobEmailPriorities7),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(JobEmailPriorities7))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                                     label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of importance of including the details on the company product development process in the job contact message"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AdsPriorities1),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AdsPriorities1))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                           label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of relevence the online adverts to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AdsPriorities2),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AdsPriorities2))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                           label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of honesty in the goals of the online adverts to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AdsPriorities3),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AdsPriorities3))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                           label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level of imporatnce of information in the online adverts to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AdsPriorities4),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AdsPriorities4))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                           label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing the level to which the online adverts seem to be trustworthy to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AdsPriorities5),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AdsPriorities5))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                           label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing whether the advert is from the company liked by the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AdsPriorities6),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AdsPriorities6))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                           label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing whether the on-line adverts offer something of value to the developers"))+
          xlab("Responses")+ylab("Total")
        ...
        ggplot(tik, aes(x= as.factor(AdsPriorities7),y = prop.table(..count..) * 100)) + geom_bar(width = 0.2,aes(fill=factor(AdsPriorities7))) + coord_flip() + theme(aspect.ratio = 1/2) + geom_text(aes(y = prop.table(..count..) * 100 + 0.5, 
                                                                                                                                                                                                           label = paste0(round(prop.table(..count..) * 100, digits = 2), '%')), stat = 'count', position = position_dodge(.9),size = 7) + theme_minimal()+ ggtitle(paste("A bar graph showing whether the on-line adverts avoid fluffy or vague language"))+
          xlab("Responses")+ylab("Total")
